...
| [embdotbias](embdotbias_movielens.ipynb) | MovieLens | Python CPU, GPU | Utilizing embdotbias recommender to predict movie ratings in a Python+GPU (PyTorch) environment.
